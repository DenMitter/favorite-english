    ...
    <div class="container">
        <header>
            <nav>
                ...
                <div class="buttons">
                    <a onclick="openModal('registration')" href="#" class="button btn-adaptive">Зареєструватися</a>
                    <a onclick="openModal('login')" href="#" class="button btn-transparrent btn-adaptive">Увійти</a>
                </div>
            </nav>
        </header>
        <main>
